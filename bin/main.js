...
Elm.Main.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var addUser = Elm.Native.Port.make(_elm).inboundSignal("addUser",
   "(String, Main.UserRecord)",
   function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple2"
                                                           ...
                                                           v[0])
                                                           ,_1: typeof v[1] === "object" && "age" in v[1] && "job" in v[1] ? {_: {}
                                                                                                                             ,age: typeof v[1].age === "number" ? v[1].age : _U.badPort("a number",
                                                                                                                             v[1].age)
                                                                                                                             ,job: typeof v[1].job === "string" || typeof v[1].job === "object" && v[1].job instanceof String ? v[1].job : _U.badPort("a string",
                                                                                                                             v[1].job)} : _U.badPort("an object with fields `age`, `job`",
   ...
   function (_v0) {
      return function () {
         ...
         _U.badCase($moduleName,
         "on line 18, column 34 to 38");
      }();
   },
   addUser));
   var UserRecord = F2(function (a,
   b) {
      return {_: {},age: a,job: b};
   });
