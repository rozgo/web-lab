(function() {
  var ASPECT, FAR, NEAR, SCREEN_HEIGHT, SCREEN_WIDTH, VIEW_ANGLE, animate, camera, composer, controls, directionalLight, effectBloom, effectCopy, gridHelper, gui, makeShapes, obj, params, renderer, scene, textureLoader, torus, zero;
  ...
  makeShapes = function() {
    ...
    textureLoader.load('assets/wood-color.jpg', function(texture) {
