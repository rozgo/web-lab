scene = (domScene) ->
  ...
  loadOBJ = (entity, onload) ->
    onloadOBJ = (object) ->
      ...
      # # material.uniforms.rimColor.value = new THREE.Color 0x00edff
      ...
      object.traverse (child) ->
        if child instanceof THREE.Mesh
          material.uniforms.map.value = child.material.map if child.material.map?
  ...
  loadOBJ char, (object, material) ->

    # material.uniforms.diffuse.value = new THREE.Color 0xD89072
    # object.position.x = 0
    # object.position.z = 0
